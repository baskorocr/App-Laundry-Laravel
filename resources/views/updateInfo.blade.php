...
<div class="card-body">
<form method="post" action="{{ route('updatePosts') }}" enctype="multipart/form-data">
@csrf
<div class="form-group">
<label>Judul</label>
<input type="text" value="{{$info['title']}}" name="title" class="form-control"/>
<input type="text" hidden value="{{$info['id']}}" name="id" class="form-control"/>
...
<script type="text/javascript">
    ...
    $('#summernote').summernote('code', markupStr['information']);
</script>
</body>
